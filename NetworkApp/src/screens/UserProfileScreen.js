...
const s = StyleSheet.create({
  ...
  backBtn:      { borderWidth:1, borderColor:C.border, borderRadius:10, paddingHorizontal:24, paddingVertical:10 },
  backTxt:      { color:C.gold, fontSize:14 },

  heroWrap:     { position:'relative', width:'100%', height:280, backgroundColor:C.sur2 },
  hero:         { width:'100%', height:280, resizeMode:'cover' },
  heroFallback: { width:'100%', height:280, justifyContent:'center', alignItems:'center', backgroundColor:C.sur2 },
  heroInit:     { fontSize:72, color:C.gold },
  ...
  onlineDot:    { position:'absolute', top:14, right:14, width:14, height:14, borderRadius:7,
                  backgroundColor:'#22c55e', borderWidth:2, borderColor:C.bg },

  nameRow:      { flexDirection:'row', justifyContent:'space-between', alignItems:'flex-start',
                  paddingHorizontal:20, paddingTop:20, paddingBottom:4 },
  name:         { fontSize:26, color:C.text, flex:1 },
  scoreBox:     { backgroundColor:C.goldBg, borderRadius:10, padding:8, alignItems:'center',
                  borderWidth:1, borderColor:C.goldMid, marginLeft:12, minWidth:56 },
  ...
  intentBadge:  { marginHorizontal:20, marginBottom:16, backgroundColor:C.sur2, borderRadius:20,
                  paddingHorizontal:12, paddingVertical:5, alignSelf:'flex-start',
                  borderWidth:1, borderColor:C.border2 },
  intentTxt:    { fontSize:12, color:C.sub },
  ...
  panelTitle:   { fontSize:13, color:C.sub, letterSpacing:1, marginBottom:12 },
  bioTxt:       { fontSize:14, color:C.text, lineHeight:22 },
  ...
  pill:         { backgroundColor:C.sur2, borderRadius:20, paddingHorizontal:10, paddingVertical:5,
                  borderWidth:1, borderColor:C.border },
  pillTxt:      { fontSize:12, color:C.sub },
  pillGold:     { backgroundColor:C.goldBg, borderColor:C.goldMid },
  pillGoldTxt:  { fontSize:12, color:C.gold },
